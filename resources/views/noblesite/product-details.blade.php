                                ...
                                <div class="product-details-large tab-content">
                                    <div class="tab-pane active show fade" id="pro-details1" role="tabpanel">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('/storage/'.$books->image)}}">
                                                <img src="{{asset('/storage/'.$books->image)}}" style="hight:600px; width:520px;" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pro-details2" role="tabpanel">
                                        <!-- <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('/storage/'.$books->image)}}">
                                                <img src="{{asset('/storage/'.$books->image)}}"   style="hight:1200px; width:1000px;" alt="">
                                            </a>
                                        </div> -->
                                    </div>
                    ...
                    <div class="related-product-active owl-carousel">
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="{{route('product-details',$book1->id)}}">
                                    <img src="{{asset('/storage/'.$book1->image)}}"  style="width:100px; height:100px;"alt="">
                                </a>
                                <span>hot</span>
                            ...
                            <div class="product-content">
                                <h4><a href="{{route('product-details',$book1->id)}}">{{$book1->bookname}}</a></h4>
                                <span>{{$book1->price}}</span>
                            </div>
                        </div>
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="{{route('product-details',$book2->id)}}">
                                    <img src="{{asset('/storage/'.$book2->image)}}" style="width:100px; height:100px;" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="animate-left" title="Wishlist" href="#">
                                        <i class="pe-7s-like"></i>
                            ...
                            <div class="product-content">
                                <h4><a href="{{route('product-details',$book2->id)}}">{{$book2->bookname}}</a></h4>
                                <span>${{$book2->price}}.00</span>
                            </div>
                        </div>
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="{{route('product-details',$book3->id)}}">
                                    <img src="{{asset('/storage/'.$book3->image)}}" style="width:100px; height:100px;" alt="">
                                </a>
                                <span>hot</span>
                                <div class="product-action">
                                    <a class="animate-left" title="Wishlist" href="#">
                            ...
                            <div class="product-content">
                                <h4><a href="#">{{$book3->bookname}}</a></h4>
                                <span>{{$book3->price}}.00</span>
                            </div>
                        </div>
</div>
</div> </div> 
