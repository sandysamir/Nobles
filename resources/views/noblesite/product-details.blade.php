                    ...
                    <div class="related-product-active owl-carousel">
                        ...
                        <div class="product-wrapper">
                            ...
                            <div class="product-img">
                                <a href="{{route('product-details',$bookrandoms->id)}}">
                                    <img src="{{asset('/storage/'.$bookrandoms->image)}}"  style="width:312px; height:400px;"alt="">
                                </a>
                                <span>hot</span>
                                
                            </div>
                            <div class="product-content">
                                <h4><a href="{{route('product-details',$bookrandoms->id)}}">{{$bookrandoms->bookname}}</a></h4>
                                <span>{{$bookrandoms->price}}</span>
                            </div>
